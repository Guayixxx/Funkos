...
import Modelo.funkos.atributoss.Accesorios.*;
 ...
 * @author Laura
 */
public class HombreHumano implements Hombre{
    ...
    private void registrarCamisas(){
        ...
        camisasList.add(new Camisa1Hombre());
        camisasList.add(new Camisa2Hombre());
        camisasList.add(new Camisa3Hombre());
        camisasList.add(new Camisa4Hombre());
        camisasList.add(new Camisa5Hombre());
    }
