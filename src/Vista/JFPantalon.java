 ...
 * @author isabella
 */
public class JFPantalon extends javax.swing.JFrame {

    /**
     * Creates new form JFPantalon
     */
    public JFPantalon() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.add(Bderecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 520, 90, 60));
        jPanel3.add(JlabelOpcionesC, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 450, 210, 190));

        jLabel1.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("CHOOSE YOUR OUTFIT !");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFPantalon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFPantalon().setVisible(true);
            }
        });
    }
